                                              ...
                                              kt_double searchAngleResolution, Matrix3 &rCovariance)
{
    ...
    if (bestResponse < KT_TOLERANCE)
    {
        ...
        std::cout << std::endl << "rCovariance: " << rCovariance << std::endl;
    ...
    // std::cout << "ComputePositionalCovariance: " << rCovariance << std::endl;
}
                                           ...
                                           Matrix3 &rCovariance)
{
    ...
    // std::cout << "ComputeAngularCovariance: " << rCovariance << std::endl;
}
...
kt_bool MapperGraph::TryCloseLoop(LocalizedRangeScan *pScan, const Name &rSensorName)
{
    ...
    while (!candidateChain.empty())
    {
        ...
        // std::cout << "            COARSE RESPONSE: " << coarseResponse
        //        << " (> " << m_pMapper->m_pLoopMatchMinimumResponseCoarse->GetValue() << ")" << std::endl;
        // std::cout << "            var: " << covariance(0, 0) << ",  " << covariance(1, 1)
        //        << " (< " << m_pMapper->m_pLoopMatchMaximumVarianceCoarse->GetValue() << ")" << std::endl;
            ...
            (covariance(1, 1) < m_pMapper->m_pLoopMatchMaximumVarianceCoarse->GetValue()))
        {
            ...
            // std::cout << "            FINE RESPONSE: " << fineResponse << " (>"
